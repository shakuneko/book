            ...
            <View style={styles.header}>
             ...
             <View style={styles.content}>
                ...
                <ScrollView style={{top:30,width:360,height:580,backgroundColor:'#fff'}}>
                    ...
                    <Text style={styles.word}>Rainforest</Text>
                </View>
            

                    <Image style={styles.picture1} source={{ uri: "https://raw.githubusercontent.com/shakuneko/picture2/master/Desert_Top_2.png" }} />
                    <Text style={styles.word2}>Another</Text>
                    <View style={styles.square}>
                        <Image style={styles.p1} source={{ uri: "https://raw.githubusercontent.com/shakuneko/picture2/master/Desert_Another_1.png" }} />
                    </View>
                    <View style={styles.square}>
                        <Image style={styles.p1} source={{ uri: "https://raw.githubusercontent.com/shakuneko/picture2/master/Desert_Another_2.png" }} />
                    </View>
                    <View style={styles.square}>
                        <Image style={styles.p1} source={{ uri: "https://raw.githubusercontent.com/shakuneko/picture2/master/Desert_Another_3.png" }} />
                    </View>
                    <View style={styles.square}>
                        <Image style={styles.p1} source={{ uri: "https://raw.githubusercontent.com/shakuneko/picture2/master/Desert_Another_1.png" }} />
                    </View>
